...
sub __process_pdf {
    ...
    for (split /\n/, $text) {
        next unless m{^([0-9]{2}\.[0-9]{2}\.[0-9]{4}) ([0-9]{2}\.[0-9]{2}\.[0-9]{4}) (.*?) (?:ec/Maestro|MasterCard|[^ ]+) ([0-9,.]+[+-])$};
        my ($rec, $book, $desc, $card, $value) = ($1, $2, $3, $4, $5);
        $book =~ s/([0-9]{2})\.([0-9]{2})\.([0-9]{4})/\3-\2-\1/;
        $rec =~ s/([0-9]{2})\.([0-9]{2})\.([0-9]{4})/\3-\2-\1/;
